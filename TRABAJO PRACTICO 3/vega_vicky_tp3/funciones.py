...
def opcion7(v_envios, tc):
    ...
    for i in range(len(v_acum)):
        print("Tipo de envio:", i, "Tiene el acumulado de", v_acum[i])
...
def opcion8(v_acum):
    ...
    for i in range(len(v_acum)):
        ...
        if mayor is None or v_acum[i] > mayor:
            mayor = v_acum[i]
            tipo = i

    print("El mayor tipo envio:", tipo, "con", mayor)
