...
#                       Opcion 5
# ======================================================================
def busqueda_secuencial_op5(v, cp): # y
...
def generar_vectores_acum_op7(v, tc):
    ...
    for i in v:
        ...
        # por las dudas
        destino = i.country()
        importe = calcular_importe(destino, i.tipo, i.codigo, i.pago)
    ...
    for i in range(len(v_acum)):
        ...
        # i = 0  1  2  3  4  5  6       # representan a cada tipo de envio
        print("La cantidad de envios para el tipo", i, "es:", v_acum[i])


        # si te piden que solo muestres lo que superan un valor "t"
        # if v_acum[i] > t:
        #    pass

        # solo muestres los tipo de envios del 3 al 5
        if 3 <= i <= 5:
            pass
