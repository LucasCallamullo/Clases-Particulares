...
def opcion1(fdt, fd):
    ...
    m_csv = open(fdt, "r")    # r = read = leer el archivo
...
def opcion7(matriz):
    ...
    for f in range(len(matriz)):  # range(7)
        ...
        print("Tipo de Envio:", f, " - Cantidad Total:", total_envios)
    ...
    for c in range(len(matriz[0])):  # range(2)
        ...
        print("Forma de Pago:", c+1, " - Cantidad Total:", total_envios)
