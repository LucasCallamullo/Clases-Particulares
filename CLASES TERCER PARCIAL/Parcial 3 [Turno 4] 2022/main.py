...
class Figurita:
    ...
    def __str__(self):
        ...
        new_pos = pos_a_palabra(self.pos)
...
def pos_a_palabra(pos):
    # pos ( 1 , 4)
    # pos           1             2           3           4

    # ind           0              1        2           3                                       100
    posiciones = ["Arquero", "Defensa", "Volante", "Delantero"]
    posi = posiciones[pos-1]      # str "Arquero"
    return posi
...
def mostrar_contador_op3(v_conteo, c):
    for i in range(len(v_conteo)):
        # i = 0, 1, 2, 3 ....
        if v_conteo[i] > c:
            print("La cantidad de figuritas del pais", i, "Son:", v_conteo[i])
